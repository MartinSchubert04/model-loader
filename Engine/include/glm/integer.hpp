...
/// Integer Functions</a>
template <length_t L, qualifier Q>
GLM_FUNC_DISCARD_DECL void umulExtended(vec<L, uint, Q> const &x, vec<L, uint, Q> const &y, vec<L, uint, Q> &msb,
                                        vec<L, uint, Q> &lsb);
...
/// Integer Functions</a>
template <length_t L, qualifier Q>
GLM_FUNC_DISCARD_DECL void imulExtended(vec<L, int, Q> const &x, vec<L, int, Q> const &y, vec<L, int, Q> &msb,
                                        vec<L, int, Q> &lsb);
